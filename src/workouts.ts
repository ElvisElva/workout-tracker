...
export const MUST_TRACK_BASELINES: Record<string, string> = {
  ...
  sprint_time: "Start with 3-4 short sprints, build toward 8",
  broad_jump_distance: "Track best clean distance and improve slowly",
};
...
export const DEFAULT_WORKOUTS: WorkoutDay[] = [
  ...
  },
  {
    ...
    sections: [
        ...
        exercises: [
          {
            ...
            isBareMinimum: true,
            isMustTrack: true,
            notes: "3x3. Track broad jump distance if you choose broad jump.",
          },
      ...
      {
        name: "Option 1 - Flat Sprints or Hill Sprints",
        exercises: [
          {
            id: "sprint-time",
            ...
            isBareMinimum: true,
            isMustTrack: true,
            notes: "Written range: 4-8x10-20 sec, rest 60-120 sec. BRMIN is 3 sprints.",
          },
        ],
      },
      {
        name: "Option 2 - 4x4 Conditioning",
        exercises: [
          time("thursday-4x4-hard-work", "Cycling / Bag / Shadow Boxing 4x4 hard work", 2, 120, {
            restSeconds: 180,
            isBareMinimum: true,
            isOptional: true,
            notes: "BRMIN: 2 rounds x 2 min hard / 3 min rest. Build toward 2-4 rounds.",
          }),
        ],
      },
      {
        ...
        exercises: [
          time("thursday-shuttle-runs-or-jump-rope", "Shuttle runs or Jump rope", 3, 60, {
            restSeconds: 60,
            notes: "Shuttle runs 3 rounds or jump rope 3x1 min.",
          }),
          time("thursday-bear-crawl", "Bear crawl", 2, 25, {
            restSeconds: 60,
            notes: "Written range: 2x20-30 sec.",
          }),
        ],
      },
      {
        ...
        exercises: [
          ...
          time("thursday-copenhagen-plank", "Copenhagen plank", 2, 30, {
            restSeconds: 60,
            isOptional: true,
            notes: "Each side. Use instead of plank/hollow if wanted.",
          }),
        ],
      },
      {
        ...
        exercises: [
          carry("thursday-farmer-carry", "Farmer carry or Suitcase carry", 2, 30, {
            ...
            restSeconds: 90,
            isMustTrack: true,
            notes: "20-40 sec, each side for suitcase carry.",
          }),
        ],
      },
      {
      ...
      },
      {
        ...
        exercises: [
          time("saturday-plank-hollow", "Plank / Hollow body hold", 2, 45, {
            isBareMinimum: true,
            notes: "Written range: 2x30-60 sec.",
          }),
